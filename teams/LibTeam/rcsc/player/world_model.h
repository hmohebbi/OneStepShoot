...
private:
    ...
    SideID M_accurate_last_kicker_side;
...
public:
    ...
    */
    ...
    void setAccurateLastKickerSide(SideID side) {
        M_accurate_last_kicker_side = side;
    }
    /*!
      \brief get the last kicker's side
      \return side id
     */
    SideID accurateLastKickerSide() const { return M_accurate_last_kicker_side; }
