...
{
//    ofstream fcout;
//    fcout.open("out.txt", ios_base::app);
//    fcout << world().time().cycle() << endl;
//    fcout << getClient()->message() << endl;
//    fcout << "last_touched " << world().accurateLastKickerSide() << endl;
//    fcout.close();
    //
